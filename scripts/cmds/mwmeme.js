...
module.exports = {
  ...
  onStart: async function ({ message, event, args, api }) {
    const imageLinks = [
      ...
      "https://i.postimg.cc/y6MWwLnz/FB-IMG-1778943706453.jpg",
      ...
      "https://i.postimg.cc/8CwpjCNj/FB-IMG-1781031976301.jpg",
      "https://i.postimg.cc/fLY1kTnT/received-3214523385554646.jpg",
    ...
    const videoLinks = [
      ...
      "https://github.com/user-attachments/assets/f3b6a332-2584-4116-b2fe-e292290c8731",
