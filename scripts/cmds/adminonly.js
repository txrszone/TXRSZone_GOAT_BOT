...
module.exports = {
	config: {
		...
		category: "owner",
		guide: {
			vi: "   {p}{n} [on | off]: bật/tắt chế độ chỉ admin mới có thể sử dụng bot"
				+ "\n   {p}{n} noti [on | off]: bật/tắt thông báo khi người dùng không phải là admin sử dụng bot",
			en: "   {p}{n} [on | off]: turn on/off the mode only admin can use bot"
				+ "\n   {p}{n} noti [on | off]: turn on/off the notification when user is not admin use bot"
		}
	},
