module.exports = {
	config: {
		...
		category: "info",
		guide: {
			vi: "   {p}{n} add <groupTagName> <@tags>: dùng để thêm nhóm tag mới hoặc thêm thành viên vào nhóm tag đã có"
				+ "\n   Ví dụ:"
				+ "\n    {p}{n} add TEAM1 @tag1 @tag2"
				+ "\n\n   {p}{n} del <groupTagName> <@tags>: dùng để xóa các thành viên được tag khỏi nhóm tag <groupTagName>"
				+ "\n   Ví dụ:"
				+ "\n    {p}{n} del TEAM1 @tag1 @tag2"
				+ "\n\n   {p}{n} remove <groupTagName>: dùng để xóa nhóm tag"
				+ "\n   Ví dụ:"
				+ "\n    {p}{n} remove TEAM1"
				+ "\n\n	 {p}{n} tag <groupTagName>: dùng để tag nhóm tag"
				+ "\n\n   {p}{n} rename <groupTagName> | <newGroupTagName>: dùng để đổi tên nhóm tag"
				+ "\n\n   {p}{n} [list | all]: dùng để xem danh sách các nhóm tag trong nhóm chat của bạn"
				+ "\n\n   {p}{n} info <groupTagName>: dùng để xem thông tin của nhóm tag",
			en: "   {p}{n} add <groupTagName> <@tags>: use to add new group tag or add members to group tag"
				+ "\n   Example:"
				+ "\n    {p}{n} add TEAM1 @tag1 @tag2"
				+ "\n\n   {p}{n} del <groupTagName> <@tags>: use to remove members from group tag"
				+ "\n   Example:"
				+ "\n    {p}{n} del TEAM1 @tag1 @tag2"
				+ "\n\n   {p}{n} remove <groupTagName>: use to remove group tag"
				+ "\n   Example:"
				+ "\n    {p}{n} remove TEAM1"
				+ "\n\n	 {p}{n} tag <groupTagName>: use to tag group tag"
				+ "\n\n   {p}{n} rename <groupTagName> | <newGroupTagName>: use to rename group tag"
				+ "\n\n   {p}{n} [list | all]: use to view list of group tag in your group chat"
				+ "\n\n   {p}{n} info <groupTagName>: use to view info of group tag"
		}
	},
