...
module.exports = {
  ...
  onStart: async function ({ message, args }) {
    ...
    try {
      // প্রথমে জিওকোডিং API দিয়ে স্থানাঙ্ক বের করা
      const geoResponse = await axios.get(`https://api.opencagedata.com/geocode/v1/json?q=${encodeURIComponent(input)}&key=demo&limit=1`);
      ...
      // নামাজের সময় API
      const prayerResponse = await axios.get(`https://api.aladhan.com/v1/timings/${date}?latitude=${lat}&longitude=${lon}&method=8`);
